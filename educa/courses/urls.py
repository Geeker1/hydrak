...
'''
module_content_create = To create new text, video, image and file objects and adding them to the module
Includes the module_id and model_name parameters.

module_content_update = To update an existing text, video, image, or file object,
'''